        ...
        <div>
            <div className={`coin-total`}>
                <div className='coin-img'>
                    <img src='./img/h2o.png' alt='imgs' className='coin-img-coin' />
                </div>
                <div className='coin-content'>
                    ...
                    <div className='coin-gift'>
                        <span>{'SECURE YOUR LOCAL H2O SUPPLY CHAIN'}</span>
                        {/* <p style={{ display: 'flex', alignItems: 'center' }}>
                            {balance && (
                                <>
                                    <span>
                    ...
                    <div className='coin-button-group'>
                        ...
                        <button
                            ...
                            onClick={handleOpena}
                            style={{backgroundColor:'#243954 !important', color:'#72aee8', fontWeight:'bold'}}
                        >
                            {'STACK'}
                        </button>
                        <button
...
export default memo(SocietyH2oCard)
