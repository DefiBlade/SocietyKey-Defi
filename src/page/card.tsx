...
const Card = (props: {
    ...
    return (
        <div>
            <Box sx={{flexGrow: 1}} className={`coin-total ${opacity}`}>
                <Grid container spacing={2}>
                    <Grid item sm={2} xs={3} sx={{marginTop:'5px'}}>
                        <img className='coin-img' src={imgurl} alt='imgs' style={{width:'100%'}}/>
                    </Grid>
                    <Grid item sm={10} xs={9}>
                        <Box sx={{flexGrow: 1}}>
                            ...
                            <Grid container spacing={1} style={{marginBottom:'5px'}} className='margin-top-device'>
                                <Grid item xs={6}>
                                    <button
                ...
                <Fade in={openb}>
                    <Box sx={styleb} className='give-modal'>
                        ...
                        >
                            ...
                            >
                                Swap your societykeys for noble stacks
                            </a>
                        </span>
                    </Box>
                </Fade>
